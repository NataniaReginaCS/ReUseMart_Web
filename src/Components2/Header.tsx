    ...
    return (
        <header>
            <div className="w-screen bg-[#1F510F] text-white flex justify-start items-center h-20 m-0">
                <div className="flex items-center p-4 w-24 h-24">
                    <img src={logo} alt="" />
                </div>
                <div className='flex items-center font-semibold mr-50'>
                    ...
                    <a className='hover:bg-white hover:text-black h-[80px] w-[150px] max-w-[100px] justify-center flex items-center' href="/shop">
                        Shop
                    </a>
                    <a className='hover:bg-white hover:text-black h-[80px] w-[150px] max-w-[100px] justify-center flex items-center' href="">
                        Merch
                    </a>
                    <a className='hover:bg-white hover:text-black h-[80px] w-[150px] max-w-[100px] justify-center flex items-center' href="/about">
                        About
                    </a>
