...
import {
	fetchLaporanBarangHabis,
	fetchLaporanBarangTerjual,
} from "../../../api/ApiOwner";
	...
	const handlePrintLaporanBarangHabis = async () => {
		try {
			...
			data.forEach((item: any) => {
				...
				const batasAmbil = dayjs(item.tanggal_akhir)
					.add(7, "day")
					.format("D/M/YYYY");
		...
		try {
			...
			switch (reportId) {
				...
				case 6:
					...
					break;
				case 7:
					endpoint = "/api/laporanBarangHabis";
					break;
				case 8:
					endpoint = "/api/laporanBarangTerjual";
					break;
				default:
